...
<head>
	...
	//유효성 검사
	function check(){
	    if(!addBtn.notice_title.value){
	    	swal({
				icon:'warning',
                text: "제목을 입력해주세요."
           }); 

	        addBtn.notice_title.focus();
	        return false;
	    }
	     if(!addBtn.notice_content.value){            
	    	 swal({
				 icon:'warning',
                 text: "내용을 입력해주세요."
              }); 

	        addBtn.notice_content.focus();
	        return false;
	    }
...
<div class="py-4">
	...
	<div class="card card-body shadow-sm table-wrapper table-responsive" style="clear: both; text-align: center;">
		<form name="addBtn" action="/admin/notice/noticeAdd.do" target="_blank" method="post" >
       		<table class="table table-bordered" width="95%" align="center">
                   <tr>
                       <td width="20%" align="center" style="vertical-align: middle;">제목</td>
                       <td width="80%" align="left"><input type="text" class="form-control" name="notice_title" size="40" placeholder="제목을 입력하세요."></td>
                   </tr>
                   <tr>
                       <td width="20%" align="center" style="vertical-align: middle;">글내용</td>
                       <td width="80%" align="left">
                       	<textarea rows="10" cols="60" name="notice_content" class="ckeditor" id="summernote"></textarea>
                       </td>
                   </tr>
            </table>
