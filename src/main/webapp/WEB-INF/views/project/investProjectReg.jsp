	...
	<main>
		<div class="container">
			<div class="row justify-content-center py-11">
				<div class="mb-3">
						<h1 class="mb-3 h4">투자형 프로젝트 신청하기</h1>
				</div>
							  	...
							  	<div class="mb-5 mt-5">
							  		...
							  		<div class="form-group mb-4">
							  			...
							  			<div class="input-group mb-3">
							  				<input type="text" id="interestRate" class="form-control form-pill" name="interest_rate" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
							  		...
							  		<div class="form-group mb-4">
							  			...
							  			<div class="input-group mb-3">
							  				...
							  				<input type="text" id="depositDate" name="deposit_date" class="form-control form-pill" oninput="this.value = this.value.replace(/[^0-9.-]/g, '').replace(/(\..*)\./g, '$1');">
							  			</div>
							  		</div>
							  		<div class="form-group mb-4">
							  			<label for="minAmount">최소투자금액</label><br>
							  			<div class="input-group mb-3">
							  				<input type="text" id="minAmount" class="form-control form-pill" name="min_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
							  		...
							  		<div class="form-group mb-4">
							  			...
							  			<div class="input-group mb-3">
							  				<input type="text" id="expiryDate" class="form-control form-pill" name="expiry_date" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
