...
## STARTFUN 
스타트 펀은 약 6주의 기간 동안 weis 팀이 준비한 Spring 프로젝트입니다.  <br>
벤치마킹부터 시나리오 작성, 요구사항 정의서 / 명세서 작성, 스토리보드 작성, 코드 구현, 테스트까지의 <br>
...
#### (로그를 남기는 파일의 용량이 100KB가 넘으면 압축 후 새로운 로그 파일을 만드는 정책으로 파일 관리)
...
> 스토리보드 작성 시 div 위치 및 버튼 변경 이미지 등을 고려하여 프론트 작업에 많은 도움이 되었습니다.
