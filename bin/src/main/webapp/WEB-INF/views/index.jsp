...
<body>
  ...
  <header class="duik-header">
    ...
    <nav class="js-navbar-scroll navbar navbar-expand-lg navbar-dark bg-primary-md fixed-top flex-nowrap transition-bg-03s"
      ...
      <div class="container">
        <a class="navbar-brand" href="index.html"><img src="${pageContext.request.contextPath}/resources/img/logo-light.png" alt="Docs UI Kit" style="width: 150px;"></a>
  ...
  <!-- Promo Section -->
  <section class="duik-promo" style="background: url(${pageContext.request.contextPath}/resources/img-temp/promo.jpg) no-repeat center; background-size: cover;">
  ...
  <main>
      ...
      <div class="container">
        <div class="w-md-75 mx-auto">
          <h2 class="d-flex align-items-center justify-content-center text-uppercase font-weight-bold small text-space-1 mb-3">
            ...
            <img class="rounded-circle mx-2 mb-1" src="${pageContext.request.contextPath}/resources/img/hs.png" width="40" alt="Htmlstream">
          ...
          <div class="row">
            <div class="col-6 col-md-4 col-lg-3 mb-7 mb-lg-0">
              ...
              <a class="link-dark text-center d-block" data-toggle="modal" href="#exampleModal">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/modals/modal-basic.png" alt="Htmlstream">
                Basic modal
              </a>
              <!-- End Trigger Modal -->
            ...
            <div class="col-6 col-md-4 col-lg-3 mb-7 mb-lg-0">
              ...
              <a class="link-dark text-center d-block" data-toggle="modal" href="#exampleModalCenter">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/modals/modal-vertically-centered.png" alt="Htmlstream">
            ...
            <div class="col-6 col-md-4 col-lg-3">
              ...
              <a class="link-dark text-center d-block" data-toggle="modal" href="#exampleModalLong">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/modals/modal-long.png" alt="Htmlstream">
          ...
          <div class="row">
            <div class="col-6 col-md-4 col-lg-3">
              ...
              <a class="link-dark text-center d-block" data-toggle="modal" href=".bd-example-modal-sm">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/modals/modal-small.png" alt="Htmlstream">
                Small size
              </a>
              <!-- End Trigger Modal -->
            ...
            <div class="col-6 col-md-4 col-lg-3">
              ...
              <a class="link-dark text-center d-block" data-toggle="modal" href=".bd-example-modal-lg">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/modals/modal-large.png" alt="Htmlstream">
                Large size
              </a>
              <!-- End Trigger Modal -->
          ...
          <div class="row">
            <div class="col-6 col-md-4 col-lg-3 mb-7 mb-lg-0">
              <a class="text-center d-block" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/tooltips/tooltip-top.png" alt="Htmlstream">
                Tooltip on top
              </a>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 mb-7 mb-lg-0">
              <a class="text-center d-block" data-toggle="tooltip" data-placement="right" title="Tooltip on right">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/tooltips/tooltip-right.png" alt="Htmlstream">
                Tooltip on right
              </a>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 mb-7 mb-lg-0">
              <a class="text-center d-block" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/tooltips/tooltip-bottom.png" alt="Htmlstream">
                Tooltip on bottom
              </a>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 mb-7 mb-lg-0">
              <a class="text-center d-block" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
                <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/tooltips/tooltip-left.png" alt="Htmlstream">
                Tooltip on left
              </a>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-6 col-lg-3 mb-7 mb-lg-0">
              <a class="link-dark text-center d-block" tabindex="0" role="button"
                 ...
                 <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/popovers/popover-top.png" alt="Htmlstream">
                Popover on top
              </a>
            </div>
            ...
            <div class="col-6 col-lg-3 mb-7 mb-lg-0">
              <a class="link-dark text-center d-block" tabindex="0" role="button"
                 ...
                 data-content="Docs UI Kit - Forever Free, Open Source, Easy to Use!">
                 <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/popovers/popover-right.png" alt="Htmlstream">
                Popover on right
              </a>
            </div>
            ...
            <div class="col-6 col-lg-3 mb-7 mb-lg-0">
              <a class="link-dark text-center d-block" tabindex="0" role="button"
                 ...
                 data-content="Docs UI Kit - Forever Free, Open Source, Easy to Use!">
                 <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/popovers/popover-bottom.png" alt="Htmlstream">
                Popover on bottom
              </a>
            </div>
            ...
            <div class="col-6 col-lg-3 mb-7 mb-lg-0">
              <a class="link-dark text-center d-block" tabindex="0" role="button"
                 ...
                 data-content="Docs UI Kit - Forever Free, Open Source, Easy to Use!">
                 <img class="img-fluid d-block mb-2" src="${pageContext.request.contextPath}/resources/img/popovers/popover-left.png" alt="Htmlstream">
                Popover on left
              </a>
            </div>
          </div>
    ...
    <section class="py-11">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark navbar-dark bg-primary">
        <div class="container">
          <a class="navbar-brand mr-0" href="home-page-1.html"><img src="${pageContext.request.contextPath}/resources/img/logo-light.png" alt="Docs UI Kit" style="width: 150px;"></a>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand mr-0 mr-md-5 mr-lg-7" href="home-page-1.html"><img src="${pageContext.request.contextPath}/resources/img/logo-dark.png" alt="Docs UI Kit" style="width: 150px;"></a>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand" href="home-page-1.html"><img src="${pageContext.request.contextPath}/resources/img/logo-light.png" alt="Docs UI Kit" style="width: 150px;"></a>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                <a class="nav-link" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <img class="rounded-circle u-box-shadow-sm mr-2" width="35" height="35" src="${pageContext.request.contextPath}/resources/img-temp/100x100/img3.jpg" alt="Htmlstream"> Ann Dune <i class="fas fa-angle-down small ml-1"></i>
                </a>
              ...
              <ul class="ml-auto navbar-nav">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle u-box-shadow-sm mr-2" width="35" height="35" src="${pageContext.request.contextPath}/resources/img-temp/100x100/img1.jpg" alt="Htmlstream"> Nick Gray <i class="fas fa-angle-down small ml-1"></i>
                  </a>
            ...
            <div id="carouselExampleIndicators" class="carousel slide bg-light shadow" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100 rounded" src="${pageContext.request.contextPath}/resources/img-temp/1920x1280/img1.jpg" alt="First slide">
                ...
                <div class="carousel-item">
                  <img class="d-block w-100 rounded" src="${pageContext.request.contextPath}/resources/img-temp/1920x1280/img2.jpg" alt="Second slide">
                  <div class="carousel-caption d-none d-md-block">
                    <h5 class="h3 text-white mb-1">Docs UI Kit</h5>
                    <p class="mb-5">Forever Free, Open Source, Easy to Use!</p>
                  </div>
                ...
                <div class="carousel-item">
                  <img class="d-block w-100 rounded" src="${pageContext.request.contextPath}/resources/img-temp/1920x1280/img3.jpg" alt="Third slide">
                  <div class="carousel-caption d-none d-md-block">
                    <h5 class="h3 text-white mb-1">Docs UI Kit</h5>
                    <p class="mb-5">Forever Free, Open Source, Easy to Use!</p>
                  </div>
      ...
      <div class="container">
          ...
          <div class="col-lg-6 mb-4 mb-lg-0">
            <ul class="list-group">
              <li class="list-group-item">
                <div class="media">
                  <div class="d-flex mr-3">
                    <img class="rounded-circle shadow mt-1" width="40" height="40" src="${pageContext.request.contextPath}/resources/img-temp/100x100/img4.jpg" alt="Htmlstream">
                  </div>
              ...
              <li class="list-group-item">
                <div class="media">
                  <div class="d-flex mr-3">
                    <img class="rounded-circle shadow mt-1" width="40" height="40" src="${pageContext.request.contextPath}/resources/img-temp/ava/user-unknown.jpg" alt="Htmlstream">
                  </div>
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <div class="d-flex mr-3">
                    <img class="rounded-circle shadow mt-1" width="40" height="40" src="${pageContext.request.contextPath}/resources/img-temp/ava/hs.jpg" alt="Htmlstream">
                  </div>
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <div class="d-flex mr-3">
                    <img class="rounded-circle shadow mt-1" width="40" height="40" src="${pageContext.request.contextPath}/resources/img-temp/100x100/img1.jpg" alt="Htmlstream">
                  </div>
                  <div class="media-body">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-3 text-center mb-7 mb-md-0">
            <img class="shadow img-fluid rounded mt-1" src="${pageContext.request.contextPath}/resources/img-temp/200x200/img1.jpg" alt="Htmlstream">
          </div>
          <div class="col-sm-6 col-md-3 text-center mb-7 mb-md-0">
            <img class="shadow img-fluid rounded-circle mt-1" src="${pageContext.request.contextPath}/resources/img-temp/200x200/img1.jpg" alt="Htmlstream">
          </div>
          <div class="col-sm-6 col-md-3 text-center mb-7 mb-md-0">
            <img class="shadow img-fluid img-thumbnail mt-1" src="${pageContext.request.contextPath}/resources/img-temp/200x200/img1.jpg" alt="Htmlstream">
          </div>
          <div class="col-sm-6 col-md-3 text-center">
            <img class="shadow img-fluid img-thumbnail rounded-circle mt-1" src="${pageContext.request.contextPath}/resources/img-temp/200x200/img1.jpg" alt="Htmlstream">
          </div>
        </div>
        <!-- End Images -->
      </div>
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="home-page-1.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/home-page-1.png" alt="Home Page">
                </a>
              </div>
            </div>
            <!-- End Home Demo -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="contacts.html">
                  <img class="img-fluid w-100 hadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/contacts.png" alt="Contacts">
                </a>
              </div>
            </div>
            <!-- Contacts -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="home-page-2.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/home-page-2.png" alt="Home Page 2">
                </a>
              </div>
            </div>
            <!-- End Home Page 2 -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="faq.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/faq.png" alt="FAQ">
                </a>
              </div>
            </div>
            <!-- FAQ -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="home-page-3.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/home-page-3.png" alt="Home Page 3">
                </a>
              </div>
            </div>
            <!-- End Home Page 3 -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="article.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/article.png" alt="Article">
                </a>
              </div>
            </div>
            <!-- Article -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="doc-1.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/doc-1.png" alt="Docs Layout 1">
                </a>
              </div>
            </div>
            <!-- Docs Layout 1 -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="doc-2.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/doc-2.png" alt="Docs Layout 2">
                </a>
              </div>
            </div>
            <!-- Docs Layout 2 -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="doc-3.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/doc-3.png" alt="Docs Layout 3">
                </a>
              </div>
            </div>
            <!-- Docs Layout 3 -->
            ...
            <div class="card bg-transparent border-0 mb-7">
              <div class="card-body p-0">
                ...
                <a target="_blank" href="doc-4.html">
                  <img class="img-fluid w-100 shadow rounded-bottom" src="${pageContext.request.contextPath}/resources/img-temp/demo/doc-4.png" alt="Docs Layout 4">
                </a>
              </div>
            </div>
            <!-- Docs Layout 4 -->
        ...
        <div class="row">
          ...
          <div class="col-lg-7 order-first order-lg-last mb-4 mb-lg-0">
            ...
            <a target="_blank" href="https://unsplash.com/collections/4610502/docs-ui-kit">
              <img class="img-fluid w-100 duik-browser-img shadow" src="${pageContext.request.contextPath}/resources/img-temp/bonus/theme-unsplash.jpg" alt="Unsplash Docs UI Kit Collection">
            </a>
          </div>
        </div>
        <!-- End Images -->
        ...
        <div class="row">
          <div class="col-lg-7 mb-4 mb-lg-0">
            ...
            <a target="_blank" href="https://htmlstream.com/preview/docs-ui-kit/documentation/base/icons.html">
              <img class="img-fluid w-100 duik-browser-img shadow" src="${pageContext.request.contextPath}/resources/img-temp/bonus/theme-icons.jpg" alt="Font Awesome Icons">
            </a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 order-first order-lg-last mb-4 mb-lg-0">
            ...
            <a target="_blank" href="https://htmlstream.com/preview/docs-ui-kit/documentation/introduction/getting-started.html">
              <img class="img-fluid w-100 duik-browser-img shadow" src="${pageContext.request.contextPath}/resources/img-temp/bonus/theme-sources.jpg" alt="Unsplash Docs UI Kit Collection">
            </a>
          </div>
        </div>
        <!-- End Modern Tools -->
